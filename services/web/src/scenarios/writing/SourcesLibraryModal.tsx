                      ...
                      <ul className="space-y-1">
                        {mine.map((rel) => {
                          ...
                          return (
                            <li
                              key={rel}
                              className="flex items-center gap-1 rounded-lg hover:bg-muted"
                            >
                              <button
                                type="button"
                                className="flex min-w-0 flex-1 items-center gap-2 px-3 py-2 text-left text-sm text-foreground/90"
                              ...
                              <button
                                type="button"
                                className="mr-2 shrink-0 rounded p-1.5 text-muted-foreground hover:bg-background hover:text-foreground"
                                title="下载"
                                aria-label={`下载 ${rel}`}
                                onClick={() => void downloadWorkspaceFile(path)}
                              >
                      ...
                      <ul className="space-y-1">
                        {seed.map((rel) => {
                          ...
                          return (
                            <li
                              key={rel}
                              className="flex items-center gap-1 rounded-lg hover:bg-muted/80"
                            >
                              <button
                                type="button"
                                className="flex min-w-0 flex-1 items-center gap-2 px-3 py-2 text-left text-sm text-muted-foreground"
                                onDoubleClick={() => onOpenFile(path)}
                                title="系统资料 · 只读 · 双击查看"
                              >
                                <Icon
