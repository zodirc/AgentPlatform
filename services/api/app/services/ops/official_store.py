...
def suite_artifact_from_manifest(
    ...
    *,
    ...
    if "coding" in suite_l or "swebench" in suite_l or result.get("predictions"):
        from app.services.ops.official_coding_art import attach_coding_artifact_extras
        attach_coding_artifact_extras(art, manifest=manifest, ops_run_id=ops_run_id)
    return art
