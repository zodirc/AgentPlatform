...
| context（烟·升） | agent F1 / EM | **0.5479 / 0.3000**（入账 0.4557 / 0.0000） | `1029a918-773c-45c5-a414-60076161a5df` | 2026-08-15 17:12 CST 入账 · **第2轮** · n=60 · **主读为离线 `extract_pred_answer` 重打**；入账 EM=0 为当时未抽 `Answer:` · **非锚点** |
...
| coding（烟·第4轮） | resolve_rate | **0.800** | `f20e8669-f572-4aff-ae03-3e2b166eab85` | 2026-08-16 17:40–19:13 CST · parent `56b562a6-…` · **4/5**（14365 转绿；未过仅 14182）· wall **2854** · stepsΣ **409** · test_summary **0.167** · **非锚点** · 详见 `RESULTS.md` 第4轮 |
| coding（烟·第5轮） | resolve_rate | **0.800** | `01cd8c79-af58-46c7-839c-4bb6259fe452` | 2026-08-16 23:27–00:06 CST · coding-only · **4/5**（**14182 转绿**；未过仅 14365）· stepsΣ **202** · elapsedΣ **3867** · verify_receipt **0.80** · test_summary **0.50** · **非锚点** · 详见 `RESULTS.md` 第5轮 |
| coding（烟·第6轮·luna） | resolve_rate | **0.800** | `4471acba-11ce-48d6-baa8-6402ac1bbcb7` | 2026-08-17 22:58–23:41 CST · Ops parent `ec0a1226-…` · **gpt-5.6-luna** @ `api.wuai.ai` · `reasoning_effort=high` · **4/5**（未过仅 14365，同第5轮）· wall **≈2563** · stepsΣ **180** · elapsedΣ **2908** · test_summary **1.0** · verify_receipt **1.0** · **非锚点** · 详见 `RESULTS.md` 第6轮 |
| retrieval_zh（烟·第4轮） | nDCG@10 | **0.6777** | `22961e61-3b9b-4b2e-9ec7-82a4a072c6da` | 2026-08-16 · R@10 **0.8667** · R@100 **0.9167** · **勿与 BEIR 混宏分** · **非锚点** |
| retrieval（烟·第4轮） | nDCG@10 | **0.4964** | `42772fe3-5e66-4729-a789-7547fddcc572` | 2026-08-16 · R@10 **0.4711** · R@100 **0.5252**（回近 INDEX12）· **非锚点** |
| context（烟·第4轮） | agent F1 / EM | **0.5282 / 0.2667** | `cf2a1957-f95e-4d94-b38d-d279c4793848` | 2026-08-16 · n=60 · 低于第2轮对照锚 0.5479/0.30 · **非锚点** |
