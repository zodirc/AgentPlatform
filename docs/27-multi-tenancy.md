...
> **前置已落地：** [`16`](16-user-session-history.md) `owner_user_id` · [`23`](23-writing-work-model.md) Work-over-Session · [`15` §6](15-rag-and-sources.md) IX5/RE4 · [`17`](17-search-records.md) 多表 ACL 槽位  
> **关联：** [`02`](02-architecture.md) · [`03`](03-docker-runtime.md)（含多副本 §8.5 / `make up-ha`）· [`07`](07-domain-model.md) · [`12`](12-model-harness.md) Intake/Guard
...
| **runtime** | **1（默认）** | **仍 1，直到并发 Turn 顶 SLO** | 并发顶 SLO 时：`make up-ha`（`runner_id` + `RUNTIME_URL_MAP`，[`03` §8.5](03-docker-runtime.md)） |
...
| 写作路径与 Session 解耦 | 落实 [`23` §11](23-writing-work-model.md)，Session 继续不管书；一账号默认一世界 |
