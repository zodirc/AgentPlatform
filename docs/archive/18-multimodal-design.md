...
> **约束继承**：[13-rate-redlines.md](../core/13-rate-redlines.md) 速率红线 R1–R5；[10-product-experience.md](../core/10-product-experience.md) TTFB ≤ 300ms、首模型 token ≤ 800ms（P95）；[ADR-014](../core/05-agent-runtime.md) Intake 确定性编译。  
