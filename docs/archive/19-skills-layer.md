...
> **约束继承**：[13-rate-redlines.md](../core/13-rate-redlines.md) 速率红线 R1–R5；[10-product-experience.md](../core/10-product-experience.md) TTFB / 首 token；[ADR-005](../core/05-agent-runtime.md) / [ADR-006](../core/06-tools-and-context.md) / [ADR-014](../core/05-agent-runtime.md)。  
...
4. **优先级**：不与更高价值项抢（当前文档栈上多模态 [`21`](../learn/agent-system-qa.md)、Harness 补洞更优先）。
...
| 文档 | 关系 |
|------|------|
| [`06-tools-and-context.md`](../core/06-tools-and-context.md) | 工具与上下文分区；Skills 若落地挂 Context 面 |
| [`09-product-modes.md`](../core/09-product-modes.md) | ScenarioProfile 扩展点 |
| [`12-model-harness.md`](../core/12-model-harness.md) | Harness 厚度 ≠ 加 Skills 层充数 |
| [`13-rate-redlines.md`](../core/13-rate-redlines.md) | R1–R5 |
