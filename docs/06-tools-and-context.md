...
> 逐步教学模拟见 [`20-context-compaction-walkthrough.md`](20-context-compaction-walkthrough.md)。
...
检索质量下一刀（path+tag embed、树叶预算、库级 hybrid profile；**不开默认 CE**）见 [`15` §9](15-rag-and-sources.md)。
