...
> 权威总纲：[`12-model-harness.md`](12-model-harness.md)；面试：[`21`](21-agent-system-qa.md) Q14。  
...
细文：[`INTAKE-mental-model.md`](INTAKE-mental-model.md)。
...
细文：[`CONTEXT-mental-model.md`](CONTEXT-mental-model.md)。
...
| 想搞懂… | 读 | 主要落在哪一面 |
|---------|-----|----------------|
| 进门编译 / 要不要调模型 | [`INTAKE-mental-model.md`](INTAKE-mental-model.md) | 入口 |
| 窗怎么压缩 | [`CONTEXT-mental-model.md`](CONTEXT-mental-model.md) | 上下文 |
| 检索 BM25/向量 | [`RAG-mental-model.md`](RAG-mental-model.md) | 工具（`search_sources`） |
| shell 怎么箍住 | [`BWRAP-mental-model.md`](BWRAP-mental-model.md) | 工具执行外围（不改循环） |
