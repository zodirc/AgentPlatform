...
> 行为细节见 [`07-domain-model.md`](07-domain-model.md)、[`09-event-projection-pipeline.md`](09-event-projection-pipeline.md)。  
...
产生事件见 [`09-event-projection-pipeline.md`](09-event-projection-pipeline.md) §7。

## 9. Eval（Golden Turn）

人类规范：[`12-eval-and-golden-turns.md`](12-eval-and-golden-turns.md)  
