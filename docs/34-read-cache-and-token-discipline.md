...
关联：[13](13-rate-redlines.md)（R1–R5）· [06](06-tools-and-context.md) · [12](12-model-harness.md) §5.1（prompt cache）· [20](20-context-compaction-walkthrough.md) · [21](21-agent-system-qa.md)（读契约 / soft ban）· [24](24-writing-token-economy.md) WT5 · [33](33-harness-maturity-backlog.md) HM1/HM6 · [30](30-quality-and-agility.md)。
...
与 [33](33-harness-maturity-backlog.md) §0、[31](31-sandbox-escape-and-hardening.md) 同构：
...
| 层 | 现状 | 速率相关？ | Token 相关？ |
|----|------|------------|--------------|
| Soft ban | `system.md` / tool 描述禁止 read-after-complete；[21](21-agent-system-qa.md) 曾 **有意不做硬拒** | 否 | 是（拦不住） |
...
**注意：** 更新 `system.md` / `bootstrap` 描述与 [21](21-agent-system-qa.md) 口诀，避免文案与代码分叉；**RC1 以 registry 为准**，不依赖模型理解新词。
...
| 把 Ops 审计页挂进工作台导航 | 与 [29](29-ops-eval-console.md) 旁路纪律冲突 |
...
| 原理修订 | [21](21-agent-system-qa.md)「刻意不做硬拒」→ 改为「RC1 已硬拒；豁免见上」 |
