...
> Golden 切片（[29](../topics/ops-eval-console.md)）可点选调试；**切片绿 ≠ 合并证明**。
...
体验信号（环外）：`make ux-signals` · [docs/28](../README.md) PX1。
...
- [ADR-010](08-event-projection-pipeline.md) — eval 不阻塞主路径
- [ADR-014](05-agent-runtime.md) — Intake 可测性
