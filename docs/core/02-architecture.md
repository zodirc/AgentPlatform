...
Web 技术栈见 [ADR-018](03-docker-runtime.md)。部署与环境变量：**[`03-docker-runtime.md`](03-docker-runtime.md)**（含工作区、沙箱、卷）。
...
扩展宪法：**[`09-product-modes.md`](09-product-modes.md)** · [ADR-013](09-product-modes.md)
...
模块迁移表：**[`appendix-migration.md`](../archive/appendix-migration.md)**

## 8. 文档地图

完整目录见 [`docs/README.md`](../README.md)。摘要：

| 主题 | 文档 |
|------|------|
| 目标与原则 | [01](01-problems-and-goals.md) |
| 本总览 | `02`（本文） |
| 部署 | [03](03-docker-runtime.md) |
| Loop / 工具 | [05](05-agent-runtime.md) · [06](06-tools-and-context.md) |
| 领域 / 事件 | [07](07-domain-model.md) · [08](08-event-projection-pipeline.md) |
| 场景 | [09](09-product-modes.md) |
| 写作 / RAG | [topics/writing](../topics/writing/) · [rag](../topics/rag-and-sources.md) |
| 沙箱 | [sandbox](../topics/sandbox.md) |
| 契约 | [contracts](contracts.md) |

重大约束写在上述正文中（原 ADR 已退役）。

## 9. 成熟 agent 三角（自用 × 架构 × 可证明）
