...
与 [ADR-010](08-event-projection-pipeline.md) 一致。
...
- [ADR-004](08-event-projection-pipeline.md) — SSE 与事件目录
- [ADR-009](contracts.md) — 四层协议
- [ADR-010](08-event-projection-pipeline.md) — 异步投影
- [ADR-012](08-event-projection-pipeline.md) — Pull 模型决策
- [ADR-015](05-agent-runtime.md) — Cancel / interrupt / resume
- [ADR-016](05-agent-runtime.md) — 超时与卡住检测
- [ADR-017](contracts.md) — payload schema
