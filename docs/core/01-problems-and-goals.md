...
扩展宪法：一个 Runtime，多个 Scenario；一个 Loop，多组 Tool；一条事件管道，多种工作台布局。见 [ADR-013](09-product-modes.md)。
...
| P14 | **Agent Harness 厚度** — 成熟度差在 Intake/Context/Tools/Model/Guard/Proof，不靠加 pipeline 节点；见 [`14`](../topics/writing/quality.md) |
...
旧模块迁移：[`appendix-migration.md`](../archive/appendix-migration.md)。
