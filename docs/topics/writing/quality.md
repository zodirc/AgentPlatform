...
> **关联**：RAG/资料库 → [15](../rag-and-sources.md)；速率 → [13](../../core/13-rate-redlines.md) R1–R5；Harness cache → [12](../../core/12-model-harness.md)；Skills **非**质量主路径 → [19](../../archive/19-skills-layer.md)；**写作下一刀提案（WN1–WN3）在 [30](../../archive/30-quality-and-agility.md) 维护**（**WN1–WN3 ✅**），细节以 30 为准。
...
- 细节与效果闸 → [15](../rag-and-sources.md)。

---

## 4. Cache 与前缀纪律（摘要）

优先加厚 **style 卡 + 稳定 system/tools 前缀**（AH2）。微调越多次，前缀越要确定性（C1–C5 见 [12](../../core/12-model-harness.md)）。禁止为「写得更好」破坏前缀哈希。
...
3. 效果向改动过 [15](../rag-and-sources.md) 效果闸（若动检索）。  
