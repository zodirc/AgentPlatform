...
> 关联：[`09-product-modes`](../../README.md) · [`14-writing-quality`](../../README.md) · [`16-user-session-history`](../../README.md) · [`20-context-compaction-walkthrough`](../../README.md) · [ADR-020](work-model.md)  
> 约束：须满足 [速率红线 R1–R5](../../README.md)
...
- ~~多作品 / 多租户作品库~~ → **个人默认 Work 已落地**（见 [`27`](../multi-tenancy.md)）；**仍不做**作品切换器 UI、Org/显式分享  
...
[`23`](work-model.md) 已解决「换会话拆书」；**token 输入窗策略见 [`24-writing-token-economy`](../../README.md)**（按章作业面、带书签 `/compact`；不伤速率与成稿效果）。
...
3. 多作品切换 UI：产品否决（一人一默认世界）；更多 Work 仅 API/运维面，见 [`27`](../multi-tenancy.md)。
...
**完整多租户（速率宪法、TenantContext、MT\*、ADR-021、否决 Org）：** 见 [`27-multi-tenancy`](../../README.md)。
