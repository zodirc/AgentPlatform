...
> 前置：[`11-eval-and-golden-turns`](../README.md) · [`13-rate-redlines`](../README.md) · [`10-product-experience`](../README.md) · [`12-model-harness`](../README.md) · [`14-writing-quality`](../README.md)  
> **产品意图（硬）：**  
...
| Ops Golden 切片 | [29](ops-eval-console.md) `suite=golden`；**切片绿 ≠ 合并证明** |
...
三条入口（Actions / `make ci-proof` / Ops `suite=ci`）汇入同一脚本；侧轨 preflight 与 nightly 不替代完整证明。Ops 总览见 [29](ops-eval-console.md)。
...
- 不重写 Golden 体系（权威仍是 [`11`](../core/11-eval-and-golden-turns.md)）  
...
| 模块 | 关系 |
|------|------|
| [`11`](../core/11-eval-and-golden-turns.md) | PX0 **执行** 其 §4 分层；本文不另起 Golden 格式 |
| [`12`](../core/12-model-harness.md) | 加厚 Proof 面；热路径成本清单不因本方案增加常驻项 |
| [`14`](writing/quality.md) | 离线 rubric / export_lint 保持；PX2 若做则复用结构规则，不替代 WQ |
| [`08`](../core/08-event-projection-pipeline.md) | PX1 只读事件；可不改投影，或仅增只读聚合 |
| [`27`](multi-tenancy.md) | 聚合默认租户隔离；告警视图权限另定 |
| [`26`](writing/plan-suggest.md) | 同宪法（环外、不改同意门）；本方案不碰 Plan 建议 |
...
- TTFB / 首 token SLO 口径不变（[`10`](../core/10-product-experience.md)）  
- 引擎内无新增「质检」分支  
...
- 速率：[`13`](../core/13-rate-redlines.md)  
- Eval：[`11`](../core/11-eval-and-golden-turns.md) · [`eval/README.md`](../eval/README.md)  
- 体验 SLO：[`10`](../core/10-product-experience.md)  
- Harness Proof：[`12`](../core/12-model-harness.md)  
- 写作质量否决：[`14`](writing/quality.md) §1  
