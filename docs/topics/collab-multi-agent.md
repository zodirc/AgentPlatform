...
共享宪法不变（[09](../core/09-product-modes.md) / [ADR-013](../core/09-product-modes.md)）：
...
执行真相：[`delegate_runner.py`](../services/runtime/app/tools/delegate_runner.py) · [ADR-007](../core/05-agent-runtime.md) · [05 §10](../README.md)。
...
- 协作「裁判」同步模型调用
- Skills 式全文预注入角色说明书（角色 = `subagent_types`，见 [19](../archive/19-skills-layer.md)）
...
- Org / 多人实时共编 / Agent 间独立公网会话（与 [27](multi-tenancy.md) 否决 Org 一致）  
- Agent 团队市场、MCP 编排层  
...
|------|------|
| 本文 | `37` |
| 场景宪法 | [09](../core/09-product-modes.md) |
| Loop / delegate | [05](../core/05-agent-runtime.md) §10 · [ADR-007](../core/05-agent-runtime.md) |
| 工具主路径 | [06](../core/06-tools-and-context.md) §0.1 |
| 速率 | [13](../core/13-rate-redlines.md) |
| Plan | [25](writing/runway.md) · [26](writing/plan-suggest.md) |
| 契约 | [contracts.md](../core/contracts.md) |
