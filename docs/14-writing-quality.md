...
> **关联**：RAG/资料库 → [15](15-rag-and-sources.md)；速率 → [13](13-rate-redlines.md) R1–R5；Harness cache → [12](12-model-harness.md)；Skills **非**质量主路径 → [19](19-skills-layer.md)；**写作下一刀提案（WN1–WN3）在 [30](30-quality-and-agility.md) 维护**（**WN1–WN3 ✅**），细节以 30 为准。
