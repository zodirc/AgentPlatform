...
> **关联**：[03](03-docker-runtime.md) · [ADR-001](adr/001-three-service-split.md) · [ADR-003](adr/003-env-pydantic-settings.md) · [13](13-rate-redlines.md) · [28](28-proof-gate-and-ux-signals.md) · CI `runtime-lite`  
> **硬约束**：
>
...
| 在 Turn 热路径加「构建/缓存」逻辑 | 违 [13](13-rate-redlines.md)；构建属运维面 |
...
| 批 | 内容 | 风险 | 验收 |
|----|------|------|------|
| **BR0** | 本文定稿；索引挂到 [README](README.md) / [03](03-docker-runtime.md) 指针 | 无 | 评审通过 |
