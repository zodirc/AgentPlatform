# 22 — Skills 层（可组合能力包）执行方案与去留判断

> **性质**：可排期的设计 / 执行方案；**本文本身不改代码**。  
> **问题**：是否要做「像 Cursor 那样默认预注入 ~1K 级 Skills 目录」的能力包层？  
> **约束继承**：[17-execution-plan.md](17-execution-plan.md) 速率红线 R1–R5；[11-product-experience.md](11-product-experience.md) TTFB / 首 token；[ADR-005](adr/005-agentic-loop-over-pipeline.md) / [ADR-006](adr/006-tool-centric-capabilities.md) / [ADR-014](adr/014-turn-intake-over-intent-pipeline.md)。  
...
4. **优先级**：不与更高价值项抢（当前文档栈上多模态 [`21`](21-multimodal-design.md)、Harness 补洞更优先）。
...
| [`10-product-modes.md`](10-product-modes.md) | ScenarioProfile 扩展点 |
| [`14-model-harness.md`](14-model-harness.md) | Harness 厚度 ≠ 加 Skills 层充数 |
| [`17-execution-plan.md`](17-execution-plan.md) | R1–R5 |
| [`21-multimodal-design.md`](21-multimodal-design.md) | 更高优先级设计稿对照 |
