...
> **关联**：[31](31-sandbox-escape-and-hardening.md) · [32](32-execution-plane-and-local-runner.md) · [BWRAP-mental-model.md](BWRAP-mental-model.md) · 代码 `tools/core/sandbox.py` · `landlock_fs.py` · `shell.py`  
