...
**推荐阅读顺序：** 1 → 3 → 2 → 4 → 5；数字演练接 [`20`](../context-compaction-walkthrough.md)。
...
| 文档 | 用途 |
|------|------|
| [`20-context-compaction-walkthrough.md`](../context-compaction-walkthrough.md) | 带数字的逐步模拟 |
| [`21` Q9](../../README.md) | 面试问答口径 |
| [`06-tools-and-context.md`](../../core/06-tools-and-context.md) | 工具与上下文规范 |
| [`10-product-experience.md`](../../core/10-product-experience.md) | 产品体验里的满窗行为 |
| [`33-harness-maturity-backlog.md`](../../archive/33-harness-maturity-backlog.md) | HM1 软预压缩 / HM3 增量摘要 |
