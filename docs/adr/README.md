...
| [004](004-sse-turn-streaming.md) | SSE 作为 Turn 流式传输协议 | 已接受 | `09-event-projection-pipeline`、`05-agent-runtime` §7 |
...
| [010](010-async-projection-layer.md) | 异步任务与投影层不阻塞主路径 | 已接受 | `09-event-projection-pipeline` §6 |
| [011](011-domain-run-turn-1-1.md) | Run 与 Turn 1:1 绑定 | 已接受 | `07-domain-model` |
| [012](012-event-pull-sse.md) | 事件 Pull 模型与 api 独占 SSE | 已接受 | `09-event-projection-pipeline` |
| [013](013-dual-product-modes.md) | Scenario 双场景与 Profile 扩展 | 已接受 | `10-product-modes` |
| [014](014-turn-intake-over-intent-pipeline.md) | Turn Intake 替代意图分类 Pipeline | 已接受 | `05-agent-runtime` §3.1、`11-product-experience` |
