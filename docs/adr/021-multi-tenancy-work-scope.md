...
提案（2026-07-22）— 设计见 [`docs/27-multi-tenancy.md`](../27-multi-tenancy.md)；未开闸落地。  
**同日修订：** 取消「`TENANT_MODE=off` 默认关闭」叙事；划分为**产品默认结构**。
...
6. **Org / 显式共享 / 多作品切换 UI** 为后置**能力**，不是 mode 拨杆。
